...
export const metadata = buildPageMetadata({
  title: "Psiquiatra Online Santo André",
  description:
    "Atendimento psiquiátrico online para santo andré com telemedicina, acolhimento e avaliação individualizada em saúde mental.",
  path: "/psiquiatra-online-santo-andre",
});
...
const faqs = [
  {
    q: "A Clínica Ello atende presencialmente em Santo André?",
    a: "O atendimento da Clínica Ello Saúde Mental é realizado online por telemedicina. A página é voltada para pessoas de Santo André e região que buscam orientação psiquiátrica online.",
  },
  {
...
export default function Page() {
  return (
    <ServicePage
      eyebrow="Telemedicina em Santo André"
      title="Psiquiatra Online Santo André com atendimento humanizado"
      description="A Clínica Ello Saúde Mental oferece consulta psiquiátrica online para pacientes de Santo André e região, com acolhimento, escuta qualificada e plano de cuidado individualizado. O atendimento é realizado por telemedicina, sem necessidade de deslocamento."
      whenToSeek={whenToSeek}
      benefits={benefits}
      faqs={faqs}
      related={relatedFor("/psiquiatra-online-santo-andre")}
    />
  );
}
