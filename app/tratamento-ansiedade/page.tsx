        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-5 md:px-6 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h1 className="text-4xl font-black leading-tight text-[#143a63] md:text-6xl">
              Tratamento da ansiedade online com cuidado psiquiátrico
            </h1>

            <p className="mt-6 text-base leading-relaxed text-[#5f7180] md:text-lg">
              A ansiedade pode aparecer como preocupação excessiva, tensão
              constante, sensação de alerta, crises intensas, dificuldade para
              relaxar e impacto na rotina. O acompanhamento psiquiátrico online
              ajuda a avaliar os sintomas com cuidado, entender o contexto de
              cada paciente e construir um plano terapêutico individualizado.
            </p>
