        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-5 md:px-6 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h1 className="text-4xl font-black leading-tight text-[#143a63] md:text-6xl">
              Tratamento de burnout online com cuidado psiquiátrico
            </h1>

            <p className="mt-6 text-base leading-relaxed text-[#5f7180] md:text-lg">
              O burnout está relacionado ao esgotamento emocional e à
              sobrecarga, geralmente associados ao contexto profissional. Pode
              envolver cansaço intenso, irritabilidade, queda de desempenho,
              distanciamento emocional, alterações de sono e sofrimento
              persistente.
            </p>
