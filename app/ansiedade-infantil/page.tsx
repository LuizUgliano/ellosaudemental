...
export const metadata = buildPageMetadata({
  ...
  description:
    "Conteúdo educativo sobre ansiedade em crianças, sinais de alerta e busca por avaliação.",
  path: "/ansiedade-infantil",
});

const page = {
  "eyebrow": "Infância",
  "title": "Ansiedade infantil",
  "description": "Conteúdo educativo sobre ansiedade em crianças, sinais de alerta e busca por avaliação.",
  "intro": "A ansiedade infantil pode se manifestar por medos intensos, irritabilidade, queixas físicas, dificuldade de separação, alterações de sono ou recusa escolar.",
  "sections": [
    {
      "title": "O que observar em ansiedade infantil",
      "paragraphs": [
        "ansiedade infantil pode envolver mudanças emocionais, comportamentais, no sono, na concentração, no apetite ou na rotina. A intensidade, a frequência e o prejuízo no dia a dia ajudam a entender quando vale buscar avaliação profissional.",
  ...
  "faqs": [
    {
      "question": "Ansiedade infantil precisa sempre de psiquiatra?",
...
export default function Page() {
  return <SeoArticlePage {...page} related={relatedFor("/ansiedade-infantil")} />;
}
