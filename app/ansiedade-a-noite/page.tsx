...
export const metadata = buildPageMetadata({
  ...
  description:
    "Saiba por que a ansiedade pode piorar à noite e como a avaliação em saúde mental pode ajudar no cuidado.",
  path: "/ansiedade-a-noite",
});
...
export default function Page() {
  return <SeoArticlePage {...page} related={relatedFor("/ansiedade-a-noite")} />;
}
