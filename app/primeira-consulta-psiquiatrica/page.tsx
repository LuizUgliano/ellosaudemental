        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-5 md:px-6 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h1 className="text-4xl font-black leading-tight text-[#143a63] md:text-6xl">
              Primeira consulta psiquiátrica online: como funciona
            </h1>

            <p className="mt-6 text-base leading-relaxed text-[#5f7180] md:text-lg">
              A primeira consulta psiquiátrica é um momento de escuta e
              avaliação. O objetivo é compreender sintomas, histórico, rotina,
              sono, emoções e impactos na qualidade de vida para orientar um
