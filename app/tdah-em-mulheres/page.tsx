...
export const metadata = buildPageMetadata({
  title: "TDAH em mulheres",
  description:
    "Conteúdo educativo sobre TDAH em mulheres e a importância de avaliação cuidadosa.",
  path: "/tdah-em-mulheres",
});

const page = {
  "eyebrow": "TDAH",
  "title": "TDAH em mulheres",
  "description": "Conteúdo educativo sobre TDAH em mulheres e a importância de avaliação cuidadosa.",
  "intro": "Em algumas mulheres, sintomas de TDAH podem aparecer de forma menos óbvia, com sobrecarga mental, dificuldade de organização, distração e exaustão por esforço compensatório.",
  "sections": [
    {
      "title": "O que observar em TDAH em mulheres",
      "paragraphs": [
        "TDAH em mulheres pode envolver mudanças emocionais, comportamentais, no sono, na concentração, no apetite ou na rotina. A intensidade, a frequência e o prejuízo no dia a dia ajudam a entender quando vale buscar avaliação profissional.",
  ...
  "faqs": [
    {
      "question": "TDAH em mulheres precisa sempre de psiquiatra?",
...
export default function Page() {
  return <SeoArticlePage {...page} related={relatedFor("/tdah-em-mulheres")} />;
}
