...
export const metadata = buildPageMetadata({
  ...
  description:
    "Informações sobre insônia persistente, impacto na rotina e quando buscar avaliação em saúde mental.",
  path: "/insonia-cronica",
});

const page = {
  "eyebrow": "Sono",
  "title": "Insônia crônica",
  "description": "Informações sobre insônia persistente, impacto na rotina e quando buscar avaliação em saúde mental.",
  "intro": "Insônia crônica envolve dificuldade frequente para iniciar ou manter o sono, despertares recorrentes ou sono não reparador por período prolongado.",
  "sections": [
    {
      "title": "O que observar em insônia crônica",
      "paragraphs": [
        "insônia crônica pode envolver mudanças emocionais, comportamentais, no sono, na concentração, no apetite ou na rotina. A intensidade, a frequência e o prejuízo no dia a dia ajudam a entender quando vale buscar avaliação profissional.",
  ...
  "faqs": [
    {
      "question": "Insônia crônica precisa sempre de psiquiatra?",
...
export default function Page() {
  return <SeoArticlePage {...page} related={relatedFor("/insonia-cronica")} />;
}
