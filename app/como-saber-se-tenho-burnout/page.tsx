...
const page = {
  ...
  "description": "Veja sinais que podem sugerir burnout e a importância de uma avaliação individualizada.",
  "intro": "Cansaço intenso, distanciamento emocional, irritabilidade, queda de desempenho e sensação de exaustão prolongada podem acender um alerta para burnout.",
  "sections": [
    {
      "title": "O que observar em burnout",
      "paragraphs": [
        "burnout pode envolver mudanças emocionais, comportamentais, no sono, na concentração, no apetite ou na rotina. A intensidade, a frequência e o prejuízo no dia a dia ajudam a entender quando vale buscar avaliação profissional.",
