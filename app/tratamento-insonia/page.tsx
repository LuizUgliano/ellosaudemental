        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-5 md:px-6 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h1 className="text-4xl font-black leading-tight text-[#143a63] md:text-6xl">
              Tratamento da insônia online com avaliação psiquiátrica
            </h1>

            <p className="mt-6 text-base leading-relaxed text-[#5f7180] md:text-lg">
              A insônia pode aparecer como dificuldade para iniciar o sono,
              despertares durante a noite, acordar muito cedo ou sensação de
              sono não reparador. Quando o sono começa a prejudicar energia,
              humor, concentração e qualidade de vida, uma avaliação
              psiquiátrica pode ser importante.
            </p>
