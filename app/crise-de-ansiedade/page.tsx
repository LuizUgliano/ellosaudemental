...
export const metadata = buildPageMetadata({
  ...
  description:
    "Informações sobre crise de ansiedade, sintomas comuns e quando buscar atendimento em saúde mental.",
  path: "/crise-de-ansiedade",
});

const page = {
  "eyebrow": "Ansiedade",
  "title": "Crise de ansiedade",
  "description": "Informações sobre crise de ansiedade, sintomas comuns e quando buscar atendimento em saúde mental.",
  "intro": "Crises de ansiedade podem causar sensação de perda de controle, medo intenso, palpitações, tremores, falta de ar ou sensação de urgência. A avaliação profissional ajuda a diferenciar quadros e orientar o cuidado.",
  "sections": [
    {
      "title": "O que observar em crise de ansiedade",
      "paragraphs": [
        "crise de ansiedade pode envolver mudanças emocionais, comportamentais, no sono, na concentração, no apetite ou na rotina. A intensidade, a frequência e o prejuízo no dia a dia ajudam a entender quando vale buscar avaliação profissional.",
  ...
  "faqs": [
    {
      "question": "Crise de ansiedade precisa sempre de psiquiatra?",
...
export default function Page() {
  return <SeoArticlePage {...page} related={relatedFor("/crise-de-ansiedade")} />;
}
