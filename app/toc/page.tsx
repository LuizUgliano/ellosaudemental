...
export const metadata: Metadata = {
  title: "TOC Online | Clínica Ello Saúde Mental",
  description:
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-5 md:px-6 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h1 className="text-4xl font-black leading-tight text-[#143a63] md:text-6xl">
              Tratamento do TOC online com acompanhamento psiquiátrico
            </h1>

            <p className="mt-6 text-base leading-relaxed text-[#5f7180] md:text-lg">
              O TOC pode envolver pensamentos repetitivos, necessidade de
              checagem, rituais, medo de contaminação ou outras compulsões que
              trazem sofrimento. O acompanhamento psiquiátrico online ajuda a
              avaliar o quadro e orientar o tratamento.
            </p>
