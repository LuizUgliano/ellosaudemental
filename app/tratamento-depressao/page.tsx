        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-5 md:px-6 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h1 className="text-4xl font-black leading-tight text-[#143a63] md:text-6xl">
              Tratamento da depressão online com acompanhamento psiquiátrico
            </h1>

            <p className="mt-6 text-base leading-relaxed text-[#5f7180] md:text-lg">
              A depressão pode envolver tristeza persistente, perda de
              interesse, cansaço intenso, alterações de sono, mudanças no
              apetite, dificuldade de concentração e impacto importante na
              qualidade de vida. O atendimento psiquiátrico online permite uma
              avaliação cuidadosa e um plano de acompanhamento individualizado.
            </p>
