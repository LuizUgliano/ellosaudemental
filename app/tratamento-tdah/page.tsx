        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-5 md:px-6 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h1 className="text-4xl font-black leading-tight text-[#143a63] md:text-6xl">
              Avaliação e tratamento de TDAH online
            </h1>

            <p className="mt-6 text-base leading-relaxed text-[#5f7180] md:text-lg">
              O TDAH pode se manifestar por desatenção, impulsividade,
              dificuldade de organização, procrastinação, esquecimentos
              frequentes e impacto nos estudos, trabalho ou relacionamentos. A
              avaliação psiquiátrica online ajuda a investigar sintomas,
              histórico e prejuízos funcionais de forma cuidadosa.
            </p>
