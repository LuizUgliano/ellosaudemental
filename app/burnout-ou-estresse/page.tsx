...
export const metadata = buildPageMetadata({
  title: "Burnout ou estresse?",
  description:
    "Entenda diferenças gerais entre estresse intenso e burnout e quando procurar orientação profissional.",
  path: "/burnout-ou-estresse",
});

const page = {
  "eyebrow": "Burnout",
  "title": "Burnout ou estresse?",
  "description": "Entenda diferenças gerais entre estresse intenso e burnout e quando procurar orientação profissional.",
  "intro": "Estresse e burnout podem se parecer, mas nem sempre representam a mesma situação. O burnout costuma estar ligado a esgotamento persistente, especialmente relacionado ao trabalho ou sobrecarga prolongada.",
  "sections": [
    {
      "title": "O que observar em burnout ou estresse",
      "paragraphs": [
        "burnout ou estresse pode envolver mudanças emocionais, comportamentais, no sono, na concentração, no apetite ou na rotina. A intensidade, a frequência e o prejuízo no dia a dia ajudam a entender quando vale buscar avaliação profissional.",
  ...
  "faqs": [
    {
      "question": "Burnout precisa sempre de psiquiatra?",
...
export default function Page() {
  return <SeoArticlePage {...page} related={relatedFor("/burnout-ou-estresse")} />;
}
