        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-5 md:px-6 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h1 className="text-4xl font-black leading-tight text-[#143a63] md:text-6xl">
              Tratamento da síndrome do pânico online com cuidado psiquiátrico
            </h1>

            <p className="mt-6 text-base leading-relaxed text-[#5f7180] md:text-lg">
              A síndrome do pânico pode causar crises intensas de medo, sintomas
              físicos e receio de novas crises. A avaliação psiquiátrica online
              ajuda a compreender os sintomas e orientar um cuidado
              individualizado.
            </p>
