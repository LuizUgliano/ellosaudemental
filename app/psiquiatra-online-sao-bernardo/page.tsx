...
export const metadata = buildPageMetadata({
  title: "Psiquiatra Online São Bernardo",
  description:
    "Atendimento psiquiátrico online para são bernardo do campo com telemedicina, acolhimento e avaliação individualizada em saúde mental.",
  path: "/psiquiatra-online-sao-bernardo",
});
...
const faqs = [
  {
    q: "A Clínica Ello atende presencialmente em São Bernardo do Campo?",
    a: "O atendimento da Clínica Ello Saúde Mental é realizado online por telemedicina. A página é voltada para pessoas de São Bernardo do Campo e região que buscam orientação psiquiátrica online.",
  },
  {
...
export default function Page() {
  return (
    <ServicePage
      eyebrow="Telemedicina em São Bernardo do Campo"
      title="Psiquiatra Online São Bernardo com atendimento humanizado"
      description="A Clínica Ello Saúde Mental oferece consulta psiquiátrica online para pacientes de São Bernardo do Campo e região, com acolhimento, escuta qualificada e plano de cuidado individualizado. O atendimento é realizado por telemedicina, sem necessidade de deslocamento."
      whenToSeek={whenToSeek}
      benefits={benefits}
      faqs={faqs}
      related={relatedFor("/psiquiatra-online-sao-bernardo")}
    />
  );
}
