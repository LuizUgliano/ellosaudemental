...
export const metadata = buildPageMetadata({
  title: "TAG: Transtorno de Ansiedade Generalizada",
  description:
    "Entenda o que é TAG, sinais frequentes e como o acompanhamento em saúde mental pode ajudar.",
  path: "/tag",
});
...
const page = {
  "eyebrow": "Ansiedade",
  "title": "TAG: Transtorno de Ansiedade Generalizada",
  "description": "Entenda o que é TAG, sinais frequentes e como o acompanhamento em saúde mental pode ajudar.",
  "intro": "O Transtorno de Ansiedade Generalizada envolve preocupação excessiva e persistente, muitas vezes acompanhada de tensão, inquietação, cansaço, irritabilidade e dificuldade para relaxar.",
  "sections": [
    {
      "title": "O que observar em TAG",
      "paragraphs": [
        "TAG pode envolver mudanças emocionais, comportamentais, no sono, na concentração, no apetite ou na rotina. A intensidade, a frequência e o prejuízo no dia a dia ajudam a entender quando vale buscar avaliação profissional.",
  ...
  "faqs": [
    {
      "question": "TAG precisa sempre de psiquiatra?",
...
export default function Page() {
  return <SeoArticlePage {...page} related={relatedFor("/tag")} />;
}
