...
export const metadata = buildPageMetadata({
  title: "Psiquiatra Online Ribeirão Pires",
  description:
    "Atendimento psiquiátrico online para ribeirão pires com telemedicina, acolhimento e avaliação individualizada em saúde mental.",
  path: "/psiquiatra-online-ribeirao-pires",
});
...
const faqs = [
  {
    q: "A Clínica Ello atende presencialmente em Ribeirão Pires?",
    a: "O atendimento da Clínica Ello Saúde Mental é realizado online por telemedicina. A página é voltada para pessoas de Ribeirão Pires e região que buscam orientação psiquiátrica online.",
  },
  {
...
export default function Page() {
  return (
    <ServicePage
      eyebrow="Telemedicina em Ribeirão Pires"
      title="Psiquiatra Online Ribeirão Pires com atendimento humanizado"
      description="A Clínica Ello Saúde Mental oferece consulta psiquiátrica online para pacientes de Ribeirão Pires e região, com acolhimento, escuta qualificada e plano de cuidado individualizado. O atendimento é realizado por telemedicina, sem necessidade de deslocamento."
      whenToSeek={whenToSeek}
      benefits={benefits}
      faqs={faqs}
      related={relatedFor("/psiquiatra-online-ribeirao-pires")}
    />
  );
}
