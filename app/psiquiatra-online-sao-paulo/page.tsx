...
const faqs = [
  {
    q: "A Clínica Ello atende presencialmente em São Paulo?",
    a: "O atendimento da Clínica Ello Saúde Mental é realizado online por telemedicina. A página é voltada para pessoas de São Paulo e região que buscam orientação psiquiátrica online.",
  },
  {
...
export default function Page() {
  return (
    <ServicePage
      eyebrow="Telemedicina em São Paulo"
      title="Psiquiatra Online São Paulo com atendimento humanizado"
      description="A Clínica Ello Saúde Mental oferece consulta psiquiátrica online para pacientes de São Paulo e região, com acolhimento, escuta qualificada e plano de cuidado individualizado. O atendimento é realizado por telemedicina, sem necessidade de deslocamento."
