...
export const metadata = buildPageMetadata({
  title: "Fobia social",
  description:
    "Informações sobre fobia social, ansiedade em situações sociais e quando buscar avaliação.",
  path: "/fobia-social",
});

const page = {
  "eyebrow": "Ansiedade Social",
  "title": "Fobia social",
  "description": "Informações sobre fobia social, ansiedade em situações sociais e quando buscar avaliação.",
  "intro": "Fobia social pode envolver medo intenso de julgamento, exposição ou desempenho em situações sociais, trazendo sofrimento e evitação de atividades importantes.",
  "sections": [
    {
      "title": "O que observar em fobia social",
      "paragraphs": [
        "fobia social pode envolver mudanças emocionais, comportamentais, no sono, na concentração, no apetite ou na rotina. A intensidade, a frequência e o prejuízo no dia a dia ajudam a entender quando vale buscar avaliação profissional.",
  ...
  "faqs": [
    {
      "question": "Fobia social precisa sempre de psiquiatra?",
...
export default function Page() {
  return <SeoArticlePage {...page} related={relatedFor("/fobia-social")} />;
}
