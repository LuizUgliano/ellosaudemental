...
export const metadata = buildPageMetadata({
  title: "TDAH infantil",
  description:
    "Entenda sinais de TDAH em crianças e quando buscar avaliação em saúde mental infantil.",
  path: "/tdah-infantil",
});
...
const page = {
  "eyebrow": "Infância",
  "title": "TDAH infantil",
  "description": "Entenda sinais de TDAH em crianças e quando buscar avaliação em saúde mental infantil.",
  "intro": "Em crianças, o TDAH pode aparecer como desatenção, impulsividade, agitação, dificuldade de seguir rotinas e prejuízo escolar ou social.",
  "sections": [
    {
      "title": "O que observar em TDAH infantil",
      "paragraphs": [
        "TDAH infantil pode envolver mudanças emocionais, comportamentais, no sono, na concentração, no apetite ou na rotina. A intensidade, a frequência e o prejuízo no dia a dia ajudam a entender quando vale buscar avaliação profissional.",
  ...
  "faqs": [
    {
      "question": "TDAH infantil precisa sempre de psiquiatra?",
...
export default function Page() {
  return <SeoArticlePage {...page} related={relatedFor("/tdah-infantil")} />;
}
