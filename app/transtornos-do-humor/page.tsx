        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-5 md:px-6 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h1 className="text-4xl font-black leading-tight text-[#143a63] md:text-6xl">
              Acompanhamento online para transtornos do humor
            </h1>

            <p className="mt-6 text-base leading-relaxed text-[#5f7180] md:text-lg">
              Alterações persistentes de humor podem afetar energia, sono,
              concentração, relacionamentos e rotina. Oscilações importantes,
              episódios depressivos, irritabilidade frequente ou períodos de
              aceleração exigem avaliação cuidadosa para definir o melhor
              acompanhamento.
            </p>
