        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-5 md:px-6 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h1 className="text-4xl font-black leading-tight text-[#143a63] md:text-6xl">
              Quando procurar um psiquiatra? Sinais de atenção
            </h1>

            <p className="mt-6 text-base leading-relaxed text-[#5f7180] md:text-lg">
              Muitas pessoas procuram ajuda apenas quando os sintomas já estão
              muito intensos. A avaliação psiquiátrica pode ser indicada quando
              alterações emocionais, sono, energia, concentração ou
              comportamento começam a prejudicar a rotina e a qualidade de vida.
            </p>
