...
export const metadata = buildPageMetadata({
  ...
  description:
    "Informações sobre sinais de atenção no desenvolvimento infantil e a importância de avaliação especializada.",
  path: "/autismo-infantil",
});

const page = {
  "eyebrow": "Infância",
  "title": "Autismo infantil",
  "description": "Informações sobre sinais de atenção no desenvolvimento infantil e a importância de avaliação especializada.",
  "intro": "O autismo infantil pode envolver diferenças na comunicação, interação social, interesses, brincadeiras e sensibilidade sensorial. A avaliação deve ser cuidadosa e multidisciplinar quando necessário.",
  "sections": [
    {
      "title": "O que observar em autismo infantil",
      "paragraphs": [
        "autismo infantil pode envolver mudanças emocionais, comportamentais, no sono, na concentração, no apetite ou na rotina. A intensidade, a frequência e o prejuízo no dia a dia ajudam a entender quando vale buscar avaliação profissional.",
  ...
  "faqs": [
    {
      "question": "Autismo infantil precisa sempre de psiquiatra?",
...
export default function Page() {
  return <SeoArticlePage {...page} related={relatedFor("/autismo-infantil")} />;
}
