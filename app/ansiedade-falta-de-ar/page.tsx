...
export const metadata = buildPageMetadata({
  ...
  description:
    "Entenda a relação entre ansiedade e sensação de falta de ar, quando observar sinais de alerta e quando buscar avaliação profissional.",
  path: "/ansiedade-falta-de-ar",
});

const page = {
  "eyebrow": "Ansiedade",
  "title": "Ansiedade e falta de ar",
  "description": "Entenda a relação entre ansiedade e sensação de falta de ar, quando observar sinais de alerta e quando buscar avaliação profissional.",
  "intro": "A sensação de falta de ar pode aparecer em momentos de ansiedade intensa, mas sempre deve ser avaliada com responsabilidade, especialmente quando é nova, forte ou associada a outros sintomas.",
  "sections": [
    {
      "title": "O que observar em ansiedade e falta de ar",
      "paragraphs": [
        "ansiedade e falta de ar pode envolver mudanças emocionais, comportamentais, no sono, na concentração, no apetite ou na rotina. A intensidade, a frequência e o prejuízo no dia a dia ajudam a entender quando vale buscar avaliação profissional.",
  ...
  "faqs": [
    {
      "question": "Ansiedade com falta de ar precisa sempre de psiquiatra?",
...
export default function Page() {
  return <SeoArticlePage {...page} related={relatedFor("/ansiedade-falta-de-ar")} />;
}
